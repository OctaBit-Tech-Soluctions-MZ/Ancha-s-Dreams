<div class='mt--15'>
    ...
    <div class="row">
        <form class="rbt-course-field-wrapper rbt-default-form" method="POST" wire:submit.prevent='update'>
                        ...
                        <div class="upload-area">
                            <div class="brows-file-wrapper" data-black-overlay="9">
                                ...
                                <img id="createfileImage"
                                    src="{{ !empty($cover) ? $cover->temporaryUrl() : asset('storage/products/'.$cover_2) }}"
                                    alt="file image">
            ...
            @endif
            <x-ancha-dreams-taste.button-loading :title="'Editar Produto'" />
        </form>
    </div>
</div>