<div class='mt--15'>
    ...
    ['label' => 'Editar Livro', 'url' => null],
    ],
    'pageTitle' => 'Editar Livro'
    ])
    <div class="row">
        <form class="rbt-course-field-wrapper rbt-default-form" method="POST" wire:submit.prevent='update'>
            @csrf
            <div class="row g-2">
                        ...
                        <div class="upload-area">
                            <div class="brows-file-wrapper" data-black-overlay="9">
                                ...
                                <img id="createfileImage"
                                    src="{{ !empty($cover) ? $cover->temporaryUrl() : asset('storage/books/'.$cover_2) }}"
                                    alt="file image">
            ...
            <div class="row g-2">
                <div class="course-field mb-3 col-md-3">
                    ...
                    <div class="form-check form-switch">
                        <input type="checkbox" class="form-check-input" id="is_digital" wire:click='isDigital' {{ $is_digital? 'checked' : ''}}>
                    </div>
                </div>
                @if(!$is_digital)
            ...
            @endif
            <x-ancha-dreams-taste.button-loading :title="'Editar Livro'" />
        </form>
    </div>
</div>