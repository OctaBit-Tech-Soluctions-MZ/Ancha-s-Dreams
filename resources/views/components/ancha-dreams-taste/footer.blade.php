 ...
 <footer class="bg-dark py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <img src="{{ asset('assets/img/navbar-logo.svg') }}" alt="" class="logo-dark" height="18">
            ...
            <div class="col-lg-2 mt-3 mt-lg-0">
                <h5 class="text-light">Links Rapidos</h5>
                ...
                <ul class="list-unstyled ps-0 mb-0 mt-3">
                    ...
                    <li class="mt-2"><a href="{{route('shop')}}" class="text-muted" wire:navigate>Loja</a></li>
                </ul>

            </div>

            <div class="col-lg-2 mt-3 mt-lg-0">
                <h5 class="text-light">Autenticação</h5>
            ...
            <div class="col-lg-2 mt-3 mt-lg-0">
                <h5 class="text-light">Suporte</h5>
